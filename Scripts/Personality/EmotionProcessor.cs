...
namespace ViAgents.Personality
{
    ...
    public class EmotionProcessor
    {
        ...
        internal List<Reaction> ProcessText(string text)
        {
            ...
            return GenerateEvents(parsed.Trigger, parsed.Value);
        ...
        private EmotionTuple ParseEvent(string eventString)
        {
            ...
            return new EmotionTuple { Trigger = emotion, Value = intensity };
        }
